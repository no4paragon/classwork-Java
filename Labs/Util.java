...
public class Util {
    public String getMerkleRoot(ArrayList<String>input){
        ...
        oNode1.sHash = generateHash(input.get(0));
        oNode2.sHash = generateHash(input.get(1));
        oNode3.sHash = generateHash(input.get(2));
        oNode4.sHash = generateHash(input.get(3));
